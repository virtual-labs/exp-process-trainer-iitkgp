...
<div align="center">
<img class="img-fluid"  src="./images/conn3.png" alt=""><br/><br/>
...
<li>The led will glow. Now click on the 'Power' button to switch on the oscilloscope.</li></ul></li><br/>
...
<li>Now follow steps 4-5 for same throttle angle but different distance to observe the output signal as well as observation table.</li></ul><br/> 
...
<li>Bring the blower angle to 40 &deg;, clicking on anticlockwise arrow sign on 'Change Angle' button. Switch off the oscilloscope.</li></ul></li><br/>
...
<li>1-Channel-1, D-Channel-1, Ground-2, Ground-11, Y-Channel-2 and X-Y for proportional control.</li></ul></li></br>
<br/><div align="center">
...
<li><ul><li>Click on the clockwise arrow sign of 'Change Angle' button to increase the throttle angle of air blower to 40 &deg;.</li>
<li>Angle value will be shown in the yellow box beside.</li>
<li>Apply 100 &percnt; proportional band by rotating the 'proportional band' knob.</li></ul></li><br/>
...
<li>Then drag the sensor cap (colored one) from 279 mm box to 140 mm box and drop there. Connect the black wire with it (drag from it's previous position or point 3, drop on the cap in 140 mm box).</li>
<li>Then again put the cap from 'keep here the duct caps' box to 279 mm box.</li>
<li>Now follow steps 4-5 for same throttle angle but different distance to observe the output signal as well as observation table.</li></ul></li><br/> 
...
<li>Set the proportional band knob to 100 percent by rotating the 'proportional band' knob. Switch off the oscilloscope.</li></ul> </li><br/>
<br><br>
</ol>
...
<li>1-Channel-1, D-Channel-1, Ground-2, Ground-11, Y-Channel-2, X-Y and click on the toggle switch in the right side of continous control to direct it towards two-step control.</li></ul></li></br>
<br/><div align="center">
...
<li>Now click on "Square" button to observe output of the controller.</li></ul></li><br/>

<li><ul><li>Click on 'Clear' button. Now increase the overlap value to 1 by rotating the 'overlap' knob.</li>
<li>Click on 'Square' and 'Output' button to observe controller output and the output signal respectively for the particular throttle angle and sensor probe distance from the heater.</li></ul></li><br/>
...
<li>Similerly check the controller output and the output signal for 28 mm distance between sensor probe and heater following steps 4-8.</li></ul></li><br/>
